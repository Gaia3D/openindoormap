...
define(['./when-cbf8cd21', './Check-35e1a91d', './Math-69007a69', './Cartesian2-43e3a3be', './Transforms-7ab44eba', './RuntimeError-f4c64df1', './WebGLConstants-95ceb4e9', './ComponentDatatype-607c9a0c', './AttributeCompression-ea810287', './IndexDatatype-79bb407c', './IntersectionTests-1c96d4bd', './Plane-2ba7cd02', './WebMercatorProjection-3da37aae', './createTaskProcessorWorker', './EllipsoidTangentPlane-3e4a9574', './OrientedBoundingBox-36c37f30', './TerrainEncoding-f03be670'], function (when, Check, _Math, Cartesian2, Transforms, RuntimeError, WebGLConstants, ComponentDatatype, AttributeCompression, IndexDatatype, IntersectionTests, Plane, WebMercatorProjection, createTaskProcessorWorker, EllipsoidTangentPlane, OrientedBoundingBox, TerrainEncoding) { 'use strict';
