...
define(['./when-cbf8cd21', './Check-35e1a91d', './Math-69007a69', './Cartesian2-43e3a3be', './Transforms-7ab44eba', './RuntimeError-f4c64df1', './WebGLConstants-95ceb4e9', './ComponentDatatype-607c9a0c', './GeometryAttribute-52650113', './GeometryAttributes-90846c5f', './IndexDatatype-79bb407c', './GeometryOffsetAttribute-9c676324', './EllipsoidRhumbLine-357c11e7', './PolygonPipeline-011de93c', './RectangleGeometryLibrary-69a213ef'], function (when, Check, _Math, Cartesian2, Transforms, RuntimeError, WebGLConstants, ComponentDatatype, GeometryAttribute, GeometryAttributes, IndexDatatype, GeometryOffsetAttribute, EllipsoidRhumbLine, PolygonPipeline, RectangleGeometryLibrary) { 'use strict';
