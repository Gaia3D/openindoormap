...
public class DataInfoDto implements Serializable {
	...
	private Long dataId;
	// Data Group 고유번호
	@ApiModelProperty(value = "Data Group 고유번호")
	private Integer dataGroupId;
	// converter job 고유번호
	@ApiModelProperty(value = "converter job 고유번호")
	private Long converterJobId;
	// Data Group 이름
	@ApiModelProperty(value = "Data Group 이름")
	...
	// data group key
	@ApiModelProperty(value = "data group key")
	...
	// data 고유 식별번호
	@ApiModelProperty(value = "data 고유 식별번호")
	private String dataKey;
	// data 고유 식별번호
	@ApiModelProperty(value = "data 고유 식별번호")
	private String oldDataKey;
	// data 이름
	@ApiModelProperty(value = "data 이름")
	private String dataName;
	// 데이터 타입(중복). 3ds,obj,dae,collada,ifc,las,citygml,indoorgml,etc
	@ApiModelProperty(value = "데이터 타입(중복)")
	private String dataType;
	// common : 공통, public : 공개, private : 개인, group : 그룹
	@ApiModelProperty(value = "common : 공통, public : 공개, private : 개인, group : 그룹")
	private String sharing;
	// 부모 고유번호
	@ApiModelProperty(value = "부모 고유번호")
	private Long parent;
	// 부모 이름(화면 표시용)
	@ApiModelProperty(value = "부모 이름(화면 표시용)")
	private String parentName;
	
	// origin : latitude, longitude, height 를 origin에 맟춤. boundingboxcenter : latitude, longitude, height 를 boundingboxcenter에 맟춤.
	@ApiModelProperty(value = "origin : latitude, longitude, height 를 origin에 맟춤. boundingboxcenter : latitude, longitude, height 를 boundingboxcenter에 맟춤")
