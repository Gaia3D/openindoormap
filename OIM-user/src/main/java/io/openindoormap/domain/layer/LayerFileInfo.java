...
public class LayerFileInfo extends FileInfo {
	...
	// 레이어 고유번호
	@ApiModelProperty(value = "레이어 고유번호")
	private Integer layerId;
	// shape 파일을 같은 파일명으로 그룹핑 한것. shp 파일의 layer_file_id 가 group_id가 됨
	@ApiModelProperty(value = "shape 파일을 같은 파일명으로 그룹핑 한것")
	private Integer layerFileInfoTeamId;
	// 레이어명
	@ApiModelProperty(value = "레이어명")
	private String layerName;
	// layer 활성화 유무. Y: 활성화, N: 비활성화
	@ApiModelProperty(value = "layer 활성화 유무")
	private String enableYn;
	// shape 파일 인코딩
	@ApiModelProperty(value = "shape 파일 인코딩")
	private String shapeEncoding;
	
	// shape 파일 update용, sysc 컬럼
	@ApiModelProperty(value = "shape 파일 update용, sysc 컬럼")
	private String update;
	// shape 파일 버전 정보
	@ApiModelProperty(value = "shape 파일 버전 정보")
