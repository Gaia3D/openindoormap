...
@EnableWebMvc
@Configuration
@ComponentScan(basePackages = {"io.openindoormap.config", "io.openindoormap.controller.view", "io.openindoormap.controller.rest", "io.openindoormap.interceptor", "io.openindoormap.validation"}, includeFilters = {
	...
	public void addInterceptors(InterceptorRegistry registry) {
		...
		registry.addInterceptor(cSRFHandlerInterceptor)
				...
				.excludePathPatterns("/f4d/**",
					"/sign/**", "/cache/reload", "/data-groups/view-order/*", "/design-layer-groups/view-order/*", "/layer-groups/view-order/*", "/layer/insert", "/datas/**",
