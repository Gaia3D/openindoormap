...
public class AMQPConfig implements RabbitListenerConfigurer {
    ...
    public static final String ROUTING_KEY_NAME = "oim";
    public static final String EXCHANGE_NAME = "oim.exchange";
    public static final String INCOMING_QUEUE_NAME = "oim.incoming.queue";
    public static final String DEAD_LETTER_QUEUE_NAME = "oim.dead-letter.queue";
