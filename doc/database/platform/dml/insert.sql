...
values
    ...
    (8, '0', '1', '통계및이력', 'STATISTICS', 8, 0, 1, 8, '/statistics/threedimension', null, null, 'glyph-settings', 'Y', 'Y', 'Y'),
 ...
 -- (85, '0', '1', 'Api 사용 이력', 'API Use History ', 8, 8, 2, 5, '/statistics/apiuse', null, null, 'glyph-settings', 'Y', 'Y', 'Y'),
    ...
    (92, '0', '1', '공간정보 운영정책', 'CONFIGURATION', 9, 9, 2, 2, '/geopolicy/modify', null, null, 'glyph-settings', 'Y', 'Y', 'Y'),
    (93, '0', '1', '관리자 메뉴', 'ADMIN MENU', 9, 9, 2, 3, '/menu/admin-menu', null, null, 'glyph-settings', 'Y', 'Y', 'Y'),
    (94, '0', '1', '사용자 메뉴', 'USER MENU', 9, 9, 2, 4, '/menu/user-menu', null, null, 'glyph-settings', 'Y', 'Y', 'Y'),
    (95, '0', '1', '위젯', 'WIDGET', 9, 9, 2, 5, '/widget/modify', null, null, 'glyph-settings', 'Y', 'Y', 'Y'),
    (96, '0', '1', '권한', 'ROLE', 9, 9, 2, 6, '/role/list', null, null, 'glyph-settings', 'Y', 'Y', 'Y'),
    (97, '0', '1', '권한 등록', 'ROLE', 9, 9, 2, 7, '/role/input', '/role/list', null, 'glyph-settings', 'N', 'Y', 'N'),
    (98, '0', '1', '권한 수정', 'ROLE', 9, 9, 2, 8, '/role/modify', '/role/list', null, 'glyph-settings', 'N', 'Y', 'N');
