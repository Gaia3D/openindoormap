...
drop sequence if exists design_layer_building_height_seq;
...
create sequence design_layer_building_height_seq increment 1 minvalue 1 maxvalue 9999999999999999 start 1 cache 1;
