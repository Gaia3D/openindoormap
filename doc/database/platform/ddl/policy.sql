...
create table policy(
	...
	content_menu_group_root					varchar(60)			default 'io.openindoormap',
	content_user_group_root					varchar(60)			default 'io.openindoormap',
	content_layer_group_root				varchar(60)			default 'io.openindoormap',
	content_data_group_root					varchar(60)			default 'io.openindoormap',
	content_design_layer_group_root			varchar(60)			default 'io.openindoormap',
	content_data_library_group_root			varchar(60)			default 'io.openindoormap',
	content_urban_group_root			    varchar(60)			default 'io.openindoormap',
	...
	shape_upload_type						varchar(256)		default 'cpg,dbf,idx,sbn,sbx,shp,shx,prj,qpj,zip,csv',
